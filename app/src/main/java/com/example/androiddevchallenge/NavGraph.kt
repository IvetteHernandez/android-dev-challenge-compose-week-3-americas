...
import com.example.androiddevchallenge.ui.home.HomePositions
...
object MainDestinations {
    ...
    const val HOME_POSITIONS = "home_positions"
...
fun NavGraph(window: Window, startDestination: String = MainDestinations.WELCOME_ROUTE) {
    ...
    NavHost(
        ...
        composable(MainDestinations.HOME_ROUTE) {
            Home(onTap = actions.homePositions)
        }
        composable(MainDestinations.HOME_POSITIONS) {
            HomePositions()
        }
    }
}
...
class MainActions(navController: NavHostController) {
    ...
    val homePositions: () -> Unit = {
        navController.navigate(MainDestinations.HOME_POSITIONS)
    }
    val upPress: () -> Unit = {
